      ...
      ">
        <div class="home_slider_item">
            <div class="home_slider ie_hide object_fit_image">
                ...
                <picture>
                    <source media="(min-width: 1440px)" data-srcset='/Public/banner/csm_knoll-lubicool-2016x840-01_058df659fd.jpg'>
                    <source media="(min-width: 1020px)" data-srcset='Public/banner/csm_knoll-lubicool-2016x840-01_94bdd355d6.jpg'>
                    <source media="(min-width: 768px)" data-srcset='/fileadmin/_processed_/4/2/csm_knoll-lubicool-2016x840-01_6dcb1673be.jpg'>
                    <source data-srcset='Public/banner/csm_knoll-lubicool-2016x840-01_94bdd355d6.jpg'>
                    <img data-src='Public/banner/csm_knoll-lubicool-2016x840-01_aca833a686.jpg' alt="" style="width: 100%;"></source>
                    </source>
                    </source>
                    </source>
                </picture>
                    ...
                    <div class="banner_bottom_slider">
                        <div class="banner_slider_dv">
                            <div class="banner_slider_text">
                                <h1>
                                    <!--TYPO3SEARCH_begin-->Angepackt: LubiCool® am Start.
                                    <!--TYPO3SEARCH_end--></h1>
                                <div class="banner_link">
                                    <a href="aktuelles\produkte\angepackt-lubicoolr-seit-januar-am-start\index.htm" class="hyphenate">Mehr erfahren
        ...
        <div class="row">
            <div class="col-sm-6">
                <h2 class='big remove_margin_header_top hyphenate'>
                    <!--TYPO3SEARCH_begin-->Aktuelles und Termine
                    <!--TYPO3SEARCH_end--></h2></div>
            <div class="col-sm-6">
                <div class="headline_copy_image_common_para common_para common_para_light rte_atag">
                    <p>Spannende Informationen über KNOLL Mitarbeiter, Produkte, Events – KNOLL live gibt es 24/7.</p>
                </div>
                <!--contacts_headline-->
                <!--contacts_headline-->
                <div class="comman_para_link">
                    <a href="aktuelles\index.htm">Interesse an mehr?
                        <i class="material-icons">arrow_forward</i></a>
                </div>
            </div>
        </div>
...
<section class="Headline_Copy_Image secdv background_grey  " id="">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <h2 class='big remove_margin_header_top hyphenate'>
                    <!--TYPO3SEARCH_begin-->Unternehmen
                    <!--TYPO3SEARCH_end--></h2>
                <div class="headline_copy_image_common_para common_para common_para_light rte_atag">
                    <!--TYPO3SEARCH_begin-->
                    <p>Wir sind spezialisiert darauf, für unsere Kunden Gutes zu leisten. Dafür schaffen wir die besten Voraussetzungen in unserem Unternehmen. Innovation und Fortschritt nehmen wir sportlich.&nbsp;</p>
                    <!--TYPO3SEARCH_end--></div>
                <!--contacts_headline-->
                <!--contacts_headline-->
                <div class="common_para comman_para_link">
                    <a href='unternehmen\index.htm'>Mehr Einblicke
                        <i class="material-icons">arrow_forward</i></a>
                </div>
            </div>
            <div class="col-sm-6">
                <div class='right_image'>
                    <picture>
                        <!--source media="(min-width: 1024px)" srcset="/fileadmin/_processed_/4/9/csm_knoll-blechbearbeitungszentrum-644x644_01_19247c2295.jpg"><source media="(min-width: 768px)" srcset="/fileadmin/_processed_/4/9/csm_knoll-blechbearbeitungszentrum-644x644_01_938f82da96.jpg"-->
                        <img data-src="/fileadmin/_processed_/4/9/csm_knoll-blechbearbeitungszentrum-644x644_01_24217cad63.jpg" alt="Einblick in die Blechbearbeitung der KNOLL Maschinenbau GmbH"></picture>
                    <!--img src='/fileadmin/Home/knoll-blechbearbeitungszentrum-644x644_01.jpg' class='img-responsive' /-->
                    <div class="headline_copy_image_variation_1">
                        <div class="overlay-with-text">
                            <div class="inner-dv">
                                <div class="inner-text rte_atag">
                                    <!--TYPO3SEARCH_begin-->
                                    <p>Lernen Sie die KNOLL-Mitarbeiter kennen und erfahren Sie mehr über das Familienunternehmen.</p>
                                    <!--TYPO3SEARCH_end--></div>
                            </div>
                        </div>
                    </div>
...
<section class="Headline_Copy_Image secdv no_background remove_bottom_padding " id="">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <h2 class='big remove_margin_header_top hyphenate'>
                    <!--TYPO3SEARCH_begin-->Produkte
                    <!--TYPO3SEARCH_end--></h2></div>
            <div class="col-sm-6">
                <div class="headline_copy_image_common_para common_para common_para_light rte_atag">
                    <p>KNOLL ist der führende Anbieter von Förderanlagen, Filteranlagen und Pumpen für die Metallbearbeitung. Sie transportieren und trennen Späne und Kühlschmierstoffe. Ein weiterer Geschäftsbereich löst anspruchsvolle Logistikaufgaben mit Montage- und Transportsystemen.&nbsp;</p>
                </div>
                <!--contacts_headline-->
...
<section class="Headline_Copy_Image secdv background_grey remove_bottom_padding " id="">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <h2 class='big remove_margin_header_top hyphenate'>
                    <!--TYPO3SEARCH_begin-->Karriere
                    <!--TYPO3SEARCH_end--></h2></div>
            <div class="col-sm-6">
                <div class="headline_copy_image_common_para common_para common_para_light rte_atag">
                    <p>Entwickeln Sie gemeinsam mit uns ein erfolgreiches Unternehmen weiter. Wir möchten weiterwachsen und bieten Mitarbeitern und Auszubildenden sehr gute Voraussetzungen.</p>
                </div>
                <!--contacts_headline-->
                <!--contacts_headline-->
                <div class="comman_para_link">
...
<section class="Headline_Copy_Image secdv no_background remove_bottom_padding " id="">
    <div class="container">
        <div class="row">
            <div class="col-sm-6">
                <h2 class='big remove_margin_header_top hyphenate'>
                    <!--TYPO3SEARCH_begin-->Service
                    <!--TYPO3SEARCH_end--></h2></div>
            <div class="col-sm-6">
                <div class="headline_copy_image_common_para common_para common_para_light rte_atag">
                    <p>Hier finden Sie alle wichtigen Informationen und Kontakte, wenn es schnell gehen muss.&nbsp;</p>
                </div>
                <!--contacts_headline-->
                <!--contacts_headline-->
                <div class="comman_para_link">
                    <a href="service\index.htm">Service auf einen Blick
                        <i class="material-icons">arrow_forward</i></a>
                </div>
            </div>
        </div>
                ...
                <div class="row">
                    <div class="col-sm-6">
                        <div class="addr-colm ittcol">
                            <div class="addr-title">Während der Geschäftszeiten</div>
                            <div class="kontakt_no">
                                <div class="kontact_icons">
                                    <i class="material-icons icon_clear">phone</i></div>
                                <!-- -->
                    ...
                    <div class="col-sm-6">
                        <div class="addr-colm ittcol">
                            <div class="addr-title">Außerhalb der Geschäftszeiten</div>
                            <div class='kontakt_no'>
                                <div class="kontact_icons">
                                    <i class="material-icons icon_clear">phone</i></div>
                                <!-- -->
