...
<div data-am-widget="slider" class="am-slider am-slider-a5" data-am-slider='{&quot;directionNav&quot;:false}'>
    <ul class="am-slides">
        ...
        <li>
            <img src="__IMG__/_20190717204902.jpg" alt="">
        </li>
        <li>
            ...
            <switch name="cp[typeid]">
                <case value="k3">
                    <a href="{:U('Mobile/Game/k3',array('code'=>$cp[name]))}">
                        <img src="/icon/{$cp[name]}.png" style="height:55px;width:55px;main-right:12px;margin-left:3px;">
                        <h3>{$cp[title]}</h3>
                ...
                <case value="ssc">
                    <a href="{:U('Mobile/Game/oldssc',array('code'=>$cp[name]))}">
                ...
                <case value="pk10">
                    <a href="/Game.oldpk10?code={$cp[name]}">
